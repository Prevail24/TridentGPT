...
Applications such as TridentGPT, SignalFlare, CertQuest, and future Watchers services do not own knowledge—they create, update, and link Threads.
...
```yaml
provenance:
  created_by: TridentGPT
  source_application: TridentGPT
